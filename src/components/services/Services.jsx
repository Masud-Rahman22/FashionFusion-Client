    ...
    return (
        <div className="w-full h-[80vh]">
            <div className="w-full h-[50vh] bg-[#28282B] relative">
                <h1 className="text-4xl text-white text-center pt-20 font-bold">Our Services</h1>
                <p className='text-center text-white font-normal text-xl mt-4'>Which we provide</p>
                    ...
                    <Card sx={{ minHeight: '350px', width: 320 }}>
                        ...
                        <CardContent sx={{ justifyContent: 'flex-end' }}>
                            ...
                            <Typography
                                ...
                                textColor="neutral.300"
                            >
                                Providing personalized styling services where customers can receive recommendations based on their preferences, body type, and occasion, enhancing their shopping experience.
                            </Typography>
                        </CardContent>
                    </Card>
                    <Card sx={{ minHeight: '280px', width: 320 }}>
                        ...
                        <CardContent sx={{ justifyContent: 'flex-end' }}>
                            ...
                            <Typography
                                ...
                                textColor="neutral.300"
                            >
                                Ensuring convenience and accessibility through features like easy navigation, fast shipping, hassle-free returns, and responsive customer support, making shopping for clothing.
                            </Typography>
                        </CardContent>
                    </Card>
                </div>
