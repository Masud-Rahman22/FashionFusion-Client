                ...
                <form className="px-5 pb-5 pt-3 lg:pb-10 lg:pt-5 lg:px-10">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="relative">
                            <input id="email_navigate_ui_modal" type="text" placeholder="Enter Your Full Name" className="block w-full rounded-lg p-3 pl-10 outline-none drop-shadow-lg bg-white dark:bg-gray-700 dark:text-white" />
