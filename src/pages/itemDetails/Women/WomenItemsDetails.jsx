...
const WomenItemsDetails = () => {
    ...
    const { data: womenProductById = {}, isLoading, isError } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosPublic.get(`/api/womenProducts/${id}`)
            return res.data
        }
    })
            ...
            <div style={{ marginTop: '50px' }}>
                <div className="grid grid-cols-7">
                    ...
                    <div className="text-white space-y-5 col-span-3 p-20">
                        <h1 className="text-4xl">{womenProductById?.title}</h1>
                        <p className="text-xl font-light">{womenProductById?.description}</p>
...
export default WomenItemsDetails;